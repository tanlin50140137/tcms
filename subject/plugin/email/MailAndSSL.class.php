...
class MySendMail {
    ...
    */
    protected function getCommand() {
        ...
        //设置发件人
        $command[] = array("MAIL FROM: ".$this->_name."<" . $this->_from . ">\r\n", 250);
...
/*plubin/email/MailAndSSL.class.php
$mail = new MySendMail();

$mail->setServer("smtp.exmail.qq.com", "2017925@htxgcw.com", "123456Htx", 465, true); //设置smtp服务器，到服务器的SSL连接
$mail->setFrom("2017925@htxgcw.com"); //设置发件人
$mail->setReceiver("50140137@qq.com"); //设置收件人，多个收件人，调用多次
//标题、内容
$cont = <<<DOC
	<h2 style="border:1px solid #EEEEEE;width:800px;margin:auto;text-align:center;padding:20px;color:#FFFFFF;background:#E4393C;">火天信资料库</h2>
	<div style="border:1px solid #EEEEEE;border-top:none;width:800px;height:250px;margin:auto;padding:20px;color:#333333;text-align:center;">
		【火天资料库】 验证码xxxx，您正在注册成为火天信资料库用户，感谢您的支持！
		<span style="color:#999999;">切勿泄露他人</span>
	</div>
DOC;
$mail->setMail("火天资料库", $cont); //设置邮件主题、内容
$mail->sendMail(); //发送
*/